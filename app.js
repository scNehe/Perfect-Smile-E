...
// Cambiamos el título cuando la página pierde el foco
window.addEventListener('blur', () => {
    document.title = "No te vayas, Eri"; // Mensaje cuando la página pierde el foco
});

// Restauramos el título original cuando la página recibe el foco nuevamente
